...
\begin{longtable}{|P{3.5cm}|c|P{6.2cm}|P{3cm}|}
\hline
\textbf{Component} & \textbf{Qty} & \textbf{Purpose} & \textbf{Estimated Price} \\
\hline
ESP32-S3 & 1 & Edge inference, Sensor Fusion, Wi-Fi/BLE và điều khiển cảnh báo. & 150,000 VND \\
\hline
ESP32-CAM & 1 & Camera nhận diện mặt, hướng nhìn và tư thế tay. & 80,000 VND \\
\hline
MPU-6050 & 1 & Gia tốc kế và con quay hồi chuyển để phân tích chuyển động tay lái. & 30,000 VND \\
\hline
Vibration Motor DC & 1 & Tạo rung ở ghi đông để cảnh báo mức nhẹ. & 20,000 VND \\
\hline
Buzzer + LED RGB & 1 set & Còi và đèn cảnh báo theo nhiều mức nguy hiểm. & 15,000 VND \\
\hline
LiPo Battery 3.7V + Charging Module & 1 & Nguồn độc lập cho prototype. & 80,000 VND \\
\hline
