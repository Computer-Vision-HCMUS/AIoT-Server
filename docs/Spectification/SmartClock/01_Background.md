...
* Quan sát giấc ngủ, phát hiện tác nhân môi trường ảnh hưởng đến giấc ngủ và xem lại lịch sử trên dashboard.
...
* Quan sát giấc ngủ bằng Edge AI và phát hiện tác nhân môi trường làm giấc ngủ không ngon.
