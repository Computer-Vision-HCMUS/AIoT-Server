...
Sleep Mode hỗ trợ người dùng quan sát giấc ngủ, đặt báo thức và theo dõi môi trường phòng ngủ. Chế độ này tập trung vào **Sleep Monitoring Edge AI**, **Alarm Setting** và báo cáo chất lượng ngủ sau mỗi phiên.
...
| Button 4 | Nhấn để mở Alarm Setting; nhấn giữ để xem báo cáo phiên ngủ gần nhất |
...
Nếu Sleep Monitoring đang chạy, báo thức giúp người dùng thức dậy đúng giờ và có thể nhắc người dùng dừng phiên ngủ để tạo báo cáo sau khi thức dậy.
...
Màn hình Alarm Setting có thể hiển thị:

* Giờ báo thức hiện tại.
* Trạng thái báo thức On/Off.
* Thời gian hiện tại của thiết bị.
* Gợi ý dừng Sleep Monitoring sau khi người dùng thức dậy.

### Expected Result

Người dùng đặt được báo thức trước khi ngủ và thiết bị phát tín hiệu đúng giờ đã thiết lập.
...
## 6.15. Presentation Sessions Dashboard
