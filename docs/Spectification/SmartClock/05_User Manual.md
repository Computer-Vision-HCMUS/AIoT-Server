...
* Ước lượng tỷ lệ hoặc khoảng thời gian **REM/NREM**.
* Số lần trở mình nếu có dữ liệu từ gối FSR.
* Mức độ ngáy hoặc tiếng ồn môi trường nếu có dữ liệu microphone.
* Nhận xét về ánh sáng, nhiệt độ, CO2 hoặc độ ẩm phòng ngủ nếu có cảm biến tương ứng.
* Gợi ý cải thiện như giảm ánh sáng, giảm tiếng ồn hoặc điều chỉnh thời lượng ngủ.
...
* Các chức năng đánh giá giấc ngủ, ước lượng REM/NREM và luyện tập seminar trong phiên bản hiện tại mang tính hỗ trợ cơ bản, có thể được mở rộng trong các phiên bản tiếp theo.
* Khi dùng Sleep Monitoring, nên đặt SmartClock và các cảm biến liên quan ở vị trí ổn định, hạn chế nguồn tiếng ồn hoặc ánh sáng bất thường để dữ liệu đáng tin cậy hơn.
* Kết quả REM/NREM không thay thế thiết bị y tế hoặc phân tích PSG chuyên nghiệp.
