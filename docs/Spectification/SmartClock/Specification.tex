...
\begin{center}
    ...
    {\LARGE \textbf{ĐẶC TẢ HỆ THỐNG SOMNILEARNAI}} \\[0.5cm]
    {\Large \textbf{ĐỒNG HỒ THÔNG MINH AIOT HỖ TRỢ HỌC TẬP VÀ GIẤC NGỦ}} \\[0.7cm]
...
\begin{longtable}{|c|P{2.5cm}|P{3cm}|P{7.5cm}|}
\hline
...
\begin{itemize}
    \item Ghi nhận và hiển thị chính xác 100\% số phiên Pomodoro, tổng số phút tập trung và điểm đánh giá thuyết trình của người dùng ngay sau mỗi phiên học, đồng thời lưu dữ liệu để theo dõi tiến độ học tập theo ngày và tháng.
    \item Phân tích và tạo báo cáo sau mỗi phiên ngủ bao gồm thời lượng ngủ, điểm chất lượng giấc ngủ, thời gian báo thức và các yếu tố môi trường như ánh sáng, nhiệt độ, độ ẩm, CO\textsubscript{2}, giúp người dùng đánh giá thói quen ngủ hằng ngày.
    \item Đồng bộ và cập nhật dashboard trong vòng 60 giây sau khi kết thúc mỗi phiên học, ngủ hoặc thuyết trình, cung cấp thống kê theo ngày, tuần và tháng để hỗ trợ theo dõi sự cải thiện của người dùng theo thời gian.
\end{itemize}
...
\hline
Objective 2 & \textbf{Phân tích và tạo báo cáo sau mỗi phiên ngủ bao gồm thời lượng ngủ, điểm chất lượng giấc ngủ, thời gian báo thức và các yếu tố môi trường như ánh sáng, nhiệt độ, độ ẩm, CO\textsubscript{2}, giúp người dùng đánh giá thói quen ngủ hằng ngày.} \\
\hline
...
\specfigure{images/Architecture (1).png}{0.98}{Overall Use Case Diagram}

\subsection{Objective 1}

\textbf{SMART Objective:} Ghi nhận và hiển thị chính xác 100\% số phiên Pomodoro, tổng số phút tập trung và điểm đánh giá thuyết trình của người dùng ngay sau mỗi phiên học, đồng thời lưu dữ liệu để theo dõi tiến độ học tập theo ngày và tháng.
...
\specfigure{images/Architecture (2).png}{0.9}{Objective 1 Use Case Diagram}
...
\specfigure{images/Architecture (3).png}{0.88}{Pomodoro Timer Use Case Diagram}
...
\specfigure{images/Architecture (4).png}{0.9}{Seminar Practice Use Case Diagram}
...
\textbf{SMART Objective:} Phân tích và tạo báo cáo sau mỗi phiên ngủ bao gồm thời lượng ngủ, điểm chất lượng giấc ngủ, thời gian báo thức và các yếu tố môi trường như ánh sáng, nhiệt độ, độ ẩm, CO\textsubscript{2}, giúp người dùng đánh giá thói quen ngủ hằng ngày.
...
\specfigure{images/Architecture (5).png}{0.9}{Objective 2 Use Case Diagram}
...
\specfigure{images/Architecture (6).png}{0.9}{Sleep Monitoring Edge AI Use Case Diagram}
...
\specfigure{images/Architecture (7).png}{0.86}{Alarm Setting Use Case Diagram}
...
\specfigure{images/Architecture (8).png}{0.92}{Objective 3 Use Case Diagram}
...
\specfigure{images/Architecture (9).png}{0.86}{Study Sessions Dashboard Use Case Diagram}

\specfigure{images/Architecture (10).png}{0.86}{Sleep Sessions Dashboard Use Case Diagram}

\specfigure{images/Architecture (11).png}{0.86}{Presentation Sessions Dashboard Use Case Diagram}
...
\hline
Ghi nhận và hiển thị chính xác 100\% số phiên Pomodoro, tổng số phút tập trung và điểm đánh giá thuyết trình & Pomodoro Timer & Quản lý phiên tập trung và nghỉ ngơi & Người dùng duy trì nhịp học hiệu quả và có dữ liệu trên dashboard. \\
\hline
Ghi nhận và hiển thị chính xác 100\% số phiên Pomodoro, tổng số phút tập trung và điểm đánh giá thuyết trình & Seminar Practice & Luyện tập thuyết trình và nhận điểm đánh giá & Người dùng cải thiện kỹ năng trình bày và theo dõi tiến bộ. \\
\hline
Phân tích và tạo báo cáo sau mỗi phiên ngủ về thời lượng, điểm ngủ, báo thức và môi trường & Sleep Monitoring & Quan sát thời lượng ngủ và môi trường phòng ngủ & Người dùng biết chất lượng giấc ngủ và các yếu tố cần điều chỉnh. \\
\hline
Phân tích và tạo báo cáo sau mỗi phiên ngủ về thời lượng, điểm ngủ, báo thức và môi trường & Alarm Setting & Đặt giờ báo thức cục bộ & Người dùng thức dậy đúng thời gian mong muốn. \\
\hline
...
\specfigure{images/Architecture (12).png}{0.86}{Dashboard Observation Context Diagram}
...
\specfigure{images/Architecture (13).png}{0.72}{Dashboard Observation Views Diagram}
...
\specfigure{images/Architecture (14).png}{0.9}{Server-assisted Presentation Scoring Sequence Diagram}
...
\specfigure{images/Architecture (15).png}{0.72}{Synchronization Flow Diagram}
...
\begin{itemize}
    \item \textbf{Objective 1 --- Ghi nhận và hiển thị chính xác 100\% số phiên Pomodoro, tổng số phút tập trung và điểm đánh giá thuyết trình:} Pomodoro Timer và Seminar Practice.
    \item \textbf{Objective 2 --- Phân tích và tạo báo cáo sau mỗi phiên ngủ về thời lượng, điểm ngủ, báo thức và môi trường:} Sleep Monitoring Edge AI, đặt báo thức và hiển thị realtime môi trường xung quanh.
...
\begin{enumerate}
    ...
    \item Nếu thiết bị chưa có cấu hình Wi-Fi, thiết bị sẽ bật mạng setup tạm thời \texttt{SomniLearnAI\_Setup}.
    \item Trên điện thoại hoặc laptop, kết nối vào mạng setup này.
...
\subsubsection{Objective 1: Ghi nhận và hiển thị chính xác 100\% số phiên Pomodoro, tổng số phút tập trung và điểm đánh giá thuyết trình}
...
\subsubsection{Objective 2: Phân tích và tạo báo cáo sau mỗi phiên ngủ về thời lượng, điểm ngủ, báo thức và môi trường}
