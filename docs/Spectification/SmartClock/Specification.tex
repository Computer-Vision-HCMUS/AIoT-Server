...
\begin{longtable}{|P{3cm}|c|P{6.3cm}|P{3cm}|}
\hline
\textbf{Component} & \textbf{Quantity} & \textbf{Purpose} & \textbf{Estimated Price (VND)} \\
\hline
...
\begin{itemize}
    ...
    \item Các chức năng đánh giá giấc ngủ và luyện tập seminar trong phiên bản hiện tại mang tính hỗ trợ cơ bản, có thể được mở rộng trong các phiên bản tiếp theo.
...
SmartClock hướng đến việc cải thiện chất lượng nghỉ ngơi thông qua chức năng theo dõi giấc ngủ và báo thức. Người dùng có thể bắt đầu phiên theo dõi giấc ngủ, kết thúc phiên khi thức dậy và xem báo cáo đánh giá cơ bản. Chức năng báo thức giúp người dùng duy trì thời gian thức dậy ổn định.
...
\begin{itemize}
    ...
    \item Khi online, thiết bị có thể gửi dữ liệu, nhận cấu hình, lưu lịch sử và mở rộng các chức năng phân tích.
...
\begin{itemize}
    \item Các chức năng đánh giá giấc ngủ và luyện tập seminar hiện mới dừng ở mức hỗ trợ cơ bản.
...
\begin{itemize}
    ...
    \item Cải thiện thuật toán đánh giá giấc ngủ dựa trên nhiều dữ liệu hơn như ánh sáng, âm thanh hoặc thói quen sử dụng.
