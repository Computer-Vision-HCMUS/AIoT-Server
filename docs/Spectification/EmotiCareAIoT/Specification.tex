...
\begin{center}
\scriptsize
\begin{longtable}{|P{0.22\textwidth}|P{0.18\textwidth}|P{0.14\textwidth}|P{0.36\textwidth}|}
\caption{Value Proposition to Requirement Mapping}\\
\hline
\textbf{Value proposition} & \textbf{SMART objective} & \textbf{Use case} & \textbf{Giá trị người dùng mong đợi} \\
\hline
\endfirsthead
\hline
\textbf{Value proposition} & \textbf{SMART objective} & \textbf{Use case} & \textbf{Giá trị người dùng mong đợi} \\
